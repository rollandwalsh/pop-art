...
function bamDamRemoveCurrent() {
	...
	bdCurrents.forEach(function(bdCurrent) {bdCurrent.classList.remove('current')});
}
...
function bamEndorsementRemoveCurrent() {
	...
	beCurrents.forEach(function(beCurrent) {beCurrent.classList.remove('current')});
}
...
bamDamDemoNavs.forEach(function(bamDamDemoNav) {bamDamDemoNav.addEventListener('click', function() {bamDamChangeSlide(bamDamDemoNav.dataset.bddemo)})});
...
bamEndorsementNavs.forEach(function(bamEndorsementNav) {bamEndorsementNav.addEventListener('click', function() {bamEndorsementChangeSlide(bamEndorsementNav.dataset.bedemo)})});
